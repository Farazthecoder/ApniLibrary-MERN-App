...
const Signup = () => {
  ...
  const onSubmit = async (data) => {
    ...
    await axios.post("https://mernbackend-1-6o0z.onrender.com/user/signup",userInfo).then((res)=>{
      if(res.data){
      ...
      <div className="bg-white dark:bg-gray-800 p-8 rounded-lg shadow-md w-full max-w-md">
        ...
        <form onSubmit={handleSubmit(onSubmit)}>
          ...
          <div className="mb-6">
            ...
            />
            {errors.password && <span className='text-red-600'>password is required & minimum length 6</span>}
          </div>
          <button
            type="submit"
